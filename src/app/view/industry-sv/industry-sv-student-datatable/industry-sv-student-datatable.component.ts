...
@Component({
  selector: 'app-industry-sv-student-datatable',
  templateUrl: './industry-sv-student-datatable.component.html',
  styleUrls: ['./industry-sv-student-datatable.component.css']
})
export class IndustrySvStudentDatatableComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dtOptions.ajax = (dtParameters: any, callback) => {
      let student: StudentRequest = {
        industrySvId: this.activatedRoute.snapshot.paramMap.get("industrySvId")!
      };
